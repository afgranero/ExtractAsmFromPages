...
MC_TRS80_M1_L1_032B = """032BH   DEFB 84H, 52H           ; AFG note: this data was omitted in the original
...
FIX_LIST = {
    ...
    '33e2ac3b3c6417fd9307feb68f4c7e2c965ce34b54b46fc8b274b39282eef019':
        {
            '0155H': (2, SKIP,          '015EH'),           # entire section was repeated using title of the section below
            '0249H': (2, SUBSTITUTE,    '0254H'),           # address is wrong repeating a previous one
            '0251H': (1, SUBSTITUTE,    '0252H'),           # address wrong
            '0287H': (2, SUBSTITUTE,    '02B7H'),           # address wrong
            '0329H': (1, INSERT_NEXT,   '032BH'),           # data word was omitted in the original
            ...
            '0580H': (1, SKIP,          '0581H'),           # this one is complicated, not an error ...
                                                            ...
                                                            # ... but if this instruction is explicitly ...
            ...
            '0768H': (1, SKIP,          '0769H'),           # a RLCA instruction is in fact the high ...
                                                            ...
                                                            # ... correcting manually it was left there
            '07E7H': (1, SKIP,          '07E8H'),           # same as the previous one
            '0806H': (1, SKIP,          '0807H'),           # a EX AF, AF' instruction is in fact the high ...
                                                            # ... order byte of the address of the ...
                                                            # ... previous instruction in little endian ...
                                                            # ... format repeated, again probably because of ...
                                                            # ... a misinterpretation by the disassembler ...
